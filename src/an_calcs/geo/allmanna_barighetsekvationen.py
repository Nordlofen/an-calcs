    ...
    return {
        ...
        "delresultat": {
            ...
            "items": [
                ...
                _post("phi_d", r"\phi'_d", phi_d, "deg", "dimensionerande friktionsvinkel"),
                ...
                _post("q_d_prime", r"q'_d", q_d_prime, "kPa", "stapellast på grundläggningsnivå"),
        ...
        "ekvationer": {
            "title": "Ekvationer",
            "items": [
                _ekvation(r"\phi'_d = \arctan\left(\tan(\phi_k)\frac{\eta}{\gamma_m}\right)", "dimensionerande friktionsvinkel"),
                _ekvation(r"c_{ud} = \eta c' / \gamma_m \; \mathrm{eller} \; \eta c_{uk} / \gamma_{m,0}", "dimensionerande skjuvhållfasthet"),
                ...
                _ekvation(r"q'_d = \gamma d", "stapellast på grundläggningsnivå"),
                _ekvation(r"N_q = \frac{1 + \sin(\phi'_d)}{1 - \sin(\phi'_d)} e^{\pi \tan(\phi'_d)}", "bärighetsfaktor N_q"),
                _ekvation(r"N_c = \pi + 2 \; \mathrm{eller} \; \frac{N_q - 1}{\tan(\phi'_d)}", "bärighetsfaktor N_c"),
                _ekvation(r"N_{\gamma} = F \left(\frac{1 + \sin(\phi'_d)}{1 - \sin(\phi'_d)} e^{1.5 \pi \tan(\phi'_d)} - 1\right)", "bärighetsfaktor N_gamma"),
                ...
                _ekvation(
                    r"q_{bd} = \frac{c_{ud} N_c \xi_c + q'_d N_q \xi_q + 0.5 \gamma_{fri} b_{ef} N_{\gamma} \xi_{\gamma}}{\gamma_{Rd}}",
